...
After installing Varbase, the developers had a step to install **Google Analytics** and **Google Tags**.
...
2.  You'll find the settings to add and control the site Google Tags.
    ...
    1. Add your site id in the **Google Tag ID(s)** field - _**Get from your developer.**_
    2. Fill the information in the following tabs:
