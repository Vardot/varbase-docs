...
2. The People page displays a list of all user accounts on the site.
3. Use the filters to search by name, email, role, or status.
4. Use the operations column to edit or manage individual accounts.
