...
1. In the Layout Builder interface, click **Add section** at the location where you want to insert the section (between existing sections or at the end).
2. Select the desired column layout from the options presented.
3. Optionally configure section settings, including styles (see [Section Styles](section-styles.md)).
4. Click **Add section** to confirm.
5. The new section appears in the layout, ready for blocks to be placed in its columns.
...
1. Click the **Remove section** option on the section you want to delete.
2. Confirm the removal.
3. All blocks within the section will be removed along with it.
