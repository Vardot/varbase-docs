...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/u42G9phGWi3WksRxVOC1/content-designers/about-layout-builder/block-layout/media-block-image-video
---
...
![Add a New Custom Block - Media Block](<../../../.gitbook/assets/image (70).png>)

3\. Add the media and desired information e.g.(title, link), then click on **Add Block.**

![Media Block - Configure Block](<../../../.gitbook/assets/image (54).png>)
