...
![Add a New Custom Block - Rich Text](<../../../.gitbook/assets/image (41).png>)

3\. Add the text and update the desired fields, then click on **Add Block.**

![Rich Text Configure Block](<../../../.gitbook/assets/image (45).png>)
