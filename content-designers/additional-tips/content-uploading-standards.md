...
| Good | Bad |
|---|---|
| `annual-report-2025.pdf` | `AR_FINAL(2).pdf` |
| `team-photo-marketing.jpg` | `IMG_20250115_143022.jpg` |
| `product-brochure-en.pdf` | `brochure final version 3.pdf` |
| `logo-company-name.svg` | `logo.svg` |
...
|---|---|
| Team in a meeting | "Marketing team reviewing quarterly results around a conference table" |
| Company logo | "Acme Corporation logo" |
| Chart of revenue growth | "Bar chart showing 15% revenue growth from 2024 to 2025" |
| Decorative divider line | (empty) |
