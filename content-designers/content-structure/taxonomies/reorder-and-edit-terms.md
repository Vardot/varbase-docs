...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/u42G9phGWi3WksRxVOC1/content-designers/content-structure/taxonomies/reorder-and-edit-terms
---
...
![List Terms of the Taxonomy](<../../../.gitbook/assets/image (81).png>)

6\. You can drag and drop using the below icon to reorder the terms in the taxonomy.

![Reorder Terms in Taxonomy](<../../../.gitbook/assets/image (23).png>)
...
![List Terms of Blog Categories Taxonomy](<../../../.gitbook/assets/image (64).png>)

6\. Chose the term that you want to edit it then click on **Edit**

![Edit Terms](<../../../.gitbook/assets/image (57).png>)

7\. A separate page will load, the user can edit the terms of the vocabulary.

![Edit the Blog Term](<../../../.gitbook/assets/image (78).png>)
