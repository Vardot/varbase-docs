...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/u42G9phGWi3WksRxVOC1/developers/configuring-a-varbase-site/security-features/flood-contorl
---

# Flood Contorl

The [Flood Control](https://www.drupal.org/project/flood_control) module provides a simple interface to configure hidden flood control options and provides the ability to remove IP addresses and user IDs from the flood table.
