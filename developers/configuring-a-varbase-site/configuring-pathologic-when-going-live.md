...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/u42G9phGWi3WksRxVOC1/developers/configuring-a-varbase-site/configuring-pathologic-when-going-live
---
...
![Pathologic configuration section](<../../.gitbook/assets/image (35).png>)
...
![Creating new Basic page with linked contents](<../../.gitbook/assets/image (6).png>)
