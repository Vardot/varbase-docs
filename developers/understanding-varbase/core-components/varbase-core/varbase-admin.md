...
| [**Gin Type Tray**](https://www.drupal.org/project/gin\_type\_tray)                             | Themes the Type Tray module for the Gin administrative theme.                                                                                                         |
| [**Keysave**](https://www.drupal.org/project/keysave)                                           | Allows content creators to save their content via Command-S or Control-S                                                                                              |
