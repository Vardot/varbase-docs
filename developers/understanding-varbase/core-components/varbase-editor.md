...
| [**Edit Media Entity in Modal**](https://www.drupal.org/project/edit\_media\_modal)            | The tiny module provides the ability to edit a Media entity in a modal window.                                             |
