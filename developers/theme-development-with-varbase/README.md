...
### [Understanding Vartheme BS5](understanding-vartheme-bs5.md)
...
### [Creating Your Own Theme](creating-your-own-theme.md)
...
Add and manage multiple accordions inside the Accordion container in Drupal Canvas — no code. Covers dragging the Accordion components from the Library, reordering and managing items in the Layers panel, the "Keep multiple items open" setting, item settings, and holding any component inside an accordion (Text, a View, a Block or a Webform).
