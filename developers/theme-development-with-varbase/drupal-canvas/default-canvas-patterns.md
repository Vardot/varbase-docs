...
![The Patterns tab in the Library lists all 14 ready-made sections.](<../../../.gitbook/assets/Canvas Patterns - Library Patterns Tab.png>)

{% hint style="info" %}
Only **content** patterns appear here. Administrative and system pieces are never offered as
...
copies of the site-wide header and footer. They let a builder place that same composition inside
