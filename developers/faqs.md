...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/u42G9phGWi3WksRxVOC1/developers/faqs
---
...
Read the [Release Cycle and Supported Versions](../overview/release-cycle-and-supported-versions.md#varbase-supported-versions) to understand more.
