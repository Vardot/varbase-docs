...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/u42G9phGWi3WksRxVOC1/developers/updating-varbase/enabling-automatic-updates
---
...
**Repository:** [https://git.drupalcode.org/project/automatic\_updates/-/tree/3.0.x/package\_manager](https://git.drupalcode.org/project/automatic_updates/-/tree/3.0.x/package_manager?ref_type=heads)
...
This module is included by default in Varbase 9.1.x. It provides:
...
After completing the setup, your Varbase 9.1.x project should include these files:
...
After completing these steps, your Varbase 9.1.x site will be configured for secure automatic updates.
