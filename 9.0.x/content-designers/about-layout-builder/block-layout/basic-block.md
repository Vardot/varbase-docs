...
![Add a New Custom Block - Basic Block](<../../../.gitbook/assets/image (43).png>)

3\. Add the text and update the desired fields, then click on **Add Block.**

![Basic Block- Configure Block](<../../../.gitbook/assets/image (71).png>)
