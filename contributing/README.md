...
Help improve the Varbase documentation by identifying gaps, fixing errors, or writing new content. See [Contributing to Documentation](contributing-to-documentation.md) for details.

### Translations

Contribute translations to make Varbase accessible in more languages:

- Translations are managed through the Drupal.org localization server at [https://localize.drupal.org/](https://localize.drupal.org/).
...
- Varbase on Drupal.org: [https://www.drupal.org/project/varbase](https://www.drupal.org/project/varbase)
- Vardot on GitHub: [https://github.com/Vardot](https://github.com/Vardot)
- Drupal Contribution Guide: [https://www.drupal.org/community/contributor-guide](https://www.drupal.org/community/contributor-guide)
