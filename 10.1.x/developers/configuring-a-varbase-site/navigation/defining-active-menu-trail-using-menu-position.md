...
![Blogs menu item is active](<../../../.gitbook/assets/image (157).png>)

![Blogs menu item is no longer active after visiting the Blog post item](<../../../.gitbook/assets/image (155).png>)
...
![Menu Position Configuration section page with empty rules list](<../../../.gitbook/assets/image (149).png>)
...
![Adding new Menu Postion](<../../../.gitbook/assets/image (208).png>)
