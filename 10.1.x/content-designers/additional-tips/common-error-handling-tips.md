...
When uploading content to the site, be sure that the size of the images to be uploaded does not exceed 800 KB because it affects the performance of the entire site. You can use this free tool: [https://resizeimage.net/](https://resizeimage.net/).
